...
function Footer() {
  ...
  <ul className="space-y-2">
    ...
    <li className="whitespace-nowrap">
      <a href="/services" className="hover:text-amber-500 underline underline-offset-4">Services</a>
    </li>
    <li className="whitespace-nowrap">
      <a href="/portfolio" className="hover:text-amber-500 underline underline-offset-4">Portfolio</a>
    </li>
    <li className="whitespace-nowrap">
    ...
    <li className="whitespace-nowrap">
      <a href="/community" className="hover:text-amber-500 underline underline-offset-4">Community</a>
        ...
        <div className="text-center">
          <h1 className="lg:text-9xl md:text-6xl font-extrabold uppercase tracking-widest">
            YOHAN LABS
          </h1>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-6 text-sm text-gray-400">
          ...
          <div>
            <p>© YohanLabs</p>
            <p className="mt-2">An impact-first creative partner</p>
          </div>

          {/* Right Side */}
          <p className="md:max-w-md">
            This website has been built following the best practices of web
